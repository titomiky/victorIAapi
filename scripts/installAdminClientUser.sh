##### SCRIPT installAdminClientUser.sh ######
...
mkdir GitHub
cd GitHub
git clone https://titomiky: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@github.com/titomiky/adminia.git
git clone https://titomiky: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@github.com/titomiky/clientia.git
git clone https://titomiky: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@github.com/titomiky/useria.git
cd ..
...
# Run clientia, adminia and useria
...
# Befor starting apps, mongodb script with users.
...
sudo cp /home/debian/GitHub/adminia/scripts/client.holaqueai.com /etc/nginx/sites-available/client.holaqueai.com
sudo cp /home/debian/GitHub/adminia/scripts/user.holaqueai.com /etc/nginx/sites-available/user.holaqueai.com

sudo ln -s /etc/nginx/sites-available/admin.holaqueai.com /etc/nginx/sites-enabled/admin.holaqueai.com
sudo ln -s /etc/nginx/sites-available/client.holaqueai.com /etc/nginx/sites-enabled/client.holaqueai.com
sudo ln -s /etc/nginx/sites-available/user.holaqueai.com /etc/nginx/sites-enabled/user.holaqueai.com
...
sudo certbot --nginx -d a.holaqueai.com --email titomiky@gmail.com --agree-tos --no-eff-email --non-interactive
sudo certbot --nginx -d c.holaqueai.com --email titomiky@gmail.com --agree-tos --no-eff-email --non-interactive
sudo certbot --nginx -d u.holaqueai.com --email titomiky@gmail.com --agree-tos --no-eff-email --non-interactive
