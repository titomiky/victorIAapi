...
mkdir GitHub
cd GitHub
git clone https://titomiky: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@github.com/titomiky/victorIAchat.git
...
# Run victorIAchat
npm install --prefix /home/debian/GitHub/victorIAchat
