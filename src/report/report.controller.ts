...
export class ReportController {
  ...
  getClientCandidateCompetenceReport(@Param('jobOfferId') jobOfferId: string, @Param('jobOfferId') candidateId: string, @Req() request: Request): { [key: string]: number } {
    return {
      competence1: 10,
      competence2: 20,
      competence3: 9,
